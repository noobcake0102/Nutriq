...
RULE 1 — CORRECTNESS first: the product MUST be the same food as the ingredient. A DIFFERENT food is NEVER acceptable, however close or cheap. Reject these real mistakes: onions for "garlic"; cheese for "ghee"; soda for "lemon"; pickles for "dill"; chips or sour cream for "yogurt"; MARGARINE or butter spread for "coconut oil"; RICOTTA or yogurt for "milk"; SAUSAGE (kielbasa, Italian) for "ground pork"; MAYO or sriracha for "curry paste"; seasoned PASTA SAUCE for "tomato puree" or "tomato paste".
RULE 1b — DO NOT pick the "closest" product when none is genuinely the same food. If the list only contains near-misses or different products, return [] — an empty list is the CORRECT answer and far better than a wrong item in the cart.
RULE 2 — the specific CUT / TYPE / ANIMAL matters. Chicken THIGHS are NOT chicken breasts. GROUND LAMB is NOT ground beef. GREEK yogurt is NOT sour cream. CURRY POWDER is NOT garam masala. GROUND PORK is NOT pork sausage. If the exact cut/type isn't present, return [] (a substitute is handled elsewhere).
